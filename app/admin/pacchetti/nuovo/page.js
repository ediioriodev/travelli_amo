...
export default function NewPackagePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Prepare data for DB
      // Note: in a real scenario we'd ensure 'galleria' contains real Supabase URLs
      ...
      await showModal('Successo', 'Pacchetto creato con successo!')
      router.push('/admin')
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        <header className="mb-8">
          ...
          <h1 className="text-3xl font-bold mt-4 text-primary-600">Nuovo Pacchetto Viaggio</h1>
        </header>
